    ...
    <footer className="bg-gradient-to-r from-primary via-secondary to-accent animate-gradient-x text-primary-foreground">
      <div className="container py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 text-center md:text-left">
          <div className="col-span-2 md:col-span-2 md:text-left text-center flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-2">
              {LOCATIONS.map((location) => (
                <li key={location.name}>
                  <p className="text-sm text-primary-foreground/80 flex items-center justify-center md:justify-start">
