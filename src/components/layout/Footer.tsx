...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-primary via-secondary to-accent animate-gradient-x text-primary-foreground">
      <div className="container py-12 px-4 sm:px-6 lg:px-8 pl-32">
      ...
      <div className="bg-black/20">
        <div className="container py-4 flex flex-col md:flex-row justify-between items-center text-left px-4 sm:px-6 lg:px-8 pl-32">
